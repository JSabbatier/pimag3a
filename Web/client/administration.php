...
?>
                    ...
                    <td align="center">Adresses de livraison <button align="right" onclick="addaddr();" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-plus" ></span></button></td>
                        ...
                        <table id="tabeditcliinfos">
                            ...
                            <tr>
                                ...
                                <td><input type="button" id="tabeditbtnvalid" class="btn btn-default" onclick="actionCli('m')"><input type="button" class="btn btn-danger" onclick="$('#tabeditcli').slideUp('slow');" value="Annuler"></td>
                            </tr>          
                        </table>
                    </td>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                   <hr>
                    <h2 class="intro-text text-center">Administration | <strong>Employe</strong></h2>
                    <hr>
                    <br>
                    ...
                    <br>
                     <table id="tabeditemp" style="display:none;" border="1"><tr><td align="center">Informations</td>
                        ...
                        <tr>
                            <td>Rôle: </td>
                            <td><select id="tabeditemprole"><option value="Commercial" selected="selected">Commercial</option></select></td>
                        </tr>
                        <tr>
                            <td>Mail: </td>
                        ...
                        <tr>
                            ...
                            <td><input type="button" id="tabeditempbtnvalid" class="btn btn-default" onclick="actionemp('m')"><input type="button" class="btn btn-danger" onclick="$('#tabeditemp').slideUp('slow');" value="Annuler"></td>
                        </tr>          
                    </table>
                    </tr>
                    </table>
                    ...
                    <br>
                     <table id="tabeditfour" style="display:none;" border="1"><tr><td align="center">Informations</td>
                        ...
                        <tr>
                            ...
                            <td><input type="button" id="tabeditfourbtnvalid" class="btn btn-default" onclick="actionFour('m')"><input type="button" class="btn btn-danger" onclick="$('#tabeditfour').slideUp('slow');" value="Annuler"></td>
                        </tr>          
                    </table>
                    </tr>
                    </table>
