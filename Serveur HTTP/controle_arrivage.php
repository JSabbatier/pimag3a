...
require_once("../../../../mdacosta/www/pima3a/classes/daoMesureA.php");
require_once("../../../../mdacosta/www/pima3a/classes/mesureA.php");
require_once("../../../../mdacosta/www/pima3a/classes/daoBouchonA.php");
require_once("../../../../mdacosta/www/pima3a/classes/bouchonA.php");
...
else
{
	...
	//$jsonTest = json_decode(file_get_contents('php://input'), true);
	//print_r($jsonTest);
}
